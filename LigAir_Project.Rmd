...
library(ggplot2)
 #LSNO2  All 17 stations are designated Urbaine dark brown 
  ...
  lcNO2<-ggplot(data = LSNO2, aes(x=Station2, y=Moyenne2, fill = Polluant.NO2)) + geom_col  (position = "dodge")+
...
```{r graph_O3}
 #LSO3 The 14 stations include a mix of Urbaine, Périurbaine, Rurale régionale, Rurale nationale very pale blue 
  ...
  lcO3<-ggplot(data = LSO3, aes(x=Station3, y=Moyenne3, fill = Polluant.O3)) + geom_col  (position = "dodge")+
...
#LSPM10 All 13 observations stations are designated Urbaine
  ...
  lcPM10<-ggplot(data = LSPM10, aes(x=Station10, y=Moyenne10, fill = Polluant.PM10)) + geom_col  (position = "dodge")+
...
```{r graph_PM25}
 ...
 lcPM2.5<- ggplot(data = LSPM25, aes(x=Station25, y=Moyenne25, fill = Polluant.PM2.5)) + geom_col  (position = "dodge")+
